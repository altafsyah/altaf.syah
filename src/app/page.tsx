        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-x-10 gap-y-8 w-full">
              ...
              <div className="w-full p-8 bg-red-main border-4 border-main rounded-[20px]">
                <ul className="flex justify-between">
                  <li>
                    <a
                      href=""
                      className="block w-10 h-10 lg:w-24 lg:h-24 bg-white rounded-xl border-[3px] border-main hover:-rotate-3 hover:scale-105 cursor-pointer duration-75 transition-transform"
                    ></a>
                  </li>
                  <li>
                    <a
          ...
          >
            ...
            <div className="m-8 text-center">
              <h3 className="text-grey-main font-semibold text-2xl">Working @ Netta Code </h3>
            </div>
          </div>
        </div>
      </section>
