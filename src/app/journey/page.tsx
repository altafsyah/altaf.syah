            ...
            <div className="grid grid-cols-1 gap-y-8 px-5 md:px-10 md:my-10 my-5">
              <div>
                ...
                <p className="text-lg md:text-2xl text-[#727581]">
                  Hired as Frontend Developer at Netta Code Indonesia, maintain
                  current website and develop mobile app for the company.
                </p>
              </div>
              <div>
                <h1 className="font-semibold text-xl md:text-3xl text-grey-main">
                ...
                <p className="text-lg md:text-2xl text-[#727581]">
                  ...
                  House—<a href="https://www.instagram.com/ngodinghouse/" target="_blank" className="font-semibold hover:text-violet-main transition-colors duration-300">@ngodinghouse</a>, and we got our first client this year.
                  Yay!
                </p>
              </div>
            </div>
              ...
              <div>
                ...
                <p className="text-lg md:text-2xl text-[#727581]">
                  ...
                  <a
                    ...
                    className="text-violet-main font-semibold"
                  >
                    VOCASIA
                  </a>{" "}
                  for 6 months. Responsible for developing mobile apps for
                  online course at VOCASIA with other interns.
                </p>
              </div>
              <div>
                <h1 className="font-semibold text-xl md:text-3xl text-grey-main">
