  ...
  return (
    <footer className="mx-auto px-5 py-3 rounded-xl fixed bg-white backdrop-blur-xl bottom-5  right-1/2 translate-x-1/2 lg:static lg:translate-x-0">
      <ul className="flex gap-x-5">
        <li>
          <FooterLink to="/" isActive={index == 1} index={1}/>
        </li>
        <li>
          <FooterLink to="/about" isActive={index == 2} index={2}/>
        </li>
        <li>
          <FooterLink to="/project" isActive={index == 3} index={3}/>
        </li>
        <li>
          <FooterLink to="/journey" isActive={index == 4} index={4}/>
        </li>
        <li>
          <FooterLink to="/uses" isActive={index == 5} index={5}/>
        </li>
      </ul>
    </footer>
  );
